...
class Interpreter(object):
    ...
    def skip_space(self):
        """Skip whitespaces in the input moving the position."""
    ...
    def get_next_token(self):
        ...
        # is self.pos index the whitespace? 
        ...
        if current_char.isdigit():
            ...
            token = Token(INTEGER, int(concatenate))
            return token 
    ...
    def expr(self):
        ...
        # at this point INTEGER PLUS or INTEGER sequence of tokens
